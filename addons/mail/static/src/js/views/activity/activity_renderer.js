 ...
 */
class KanbanActivityDateAdapter extends AdapterComponent {
    get widgetArgs() {
...
class KanbanColumnProgressBarAdapter extends AdapterComponent {
    ...
    willUpdateProps(props) {
        this.widget.activeFilter = props.activeFilter ? this.widget.activeFilter : false;
        this.widget.columnState = props.columnState;
...
ActivityRenderer.components = {
    ActivityRecord: ActivityRecordAdapter,
    KanbanActivityDate: KanbanActivityDateAdapter,
    KanbanColumnProgressBar: KanbanColumnProgressBarAdapter
};
