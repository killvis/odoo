...
class AccountMove(models.Model):
    ...
    def write(self, vals):
        ...
        for move in self:
            ...
            if 'name' in vals and move.posted_before and move.type == 'out_invoice' and vals['name'] != move.name:
                raise UserError(_('You cannot change the number of a Customer Invoice that has been posted'))
